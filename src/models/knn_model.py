...
class KNNRecommenderModel(BaseRecommenderModel):
    """
    Recommender system based on k-nearest neighbors collaborative filtering.
    """

    def __init__(self, sim_options=None):
        BaseRecommenderModel.__init__(self, name="KNNBasic")
        default_options = {"name": "cosine", "user_based": False}
        self.model = KNNBasic(sim_options=sim_options or default_options)
